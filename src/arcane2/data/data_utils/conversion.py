...
def GSE_to_GSM(bx, by, bz, time):
    logger.info(f"Converting GSE to GSM for {len(bx)} data points")
    ...
    transformation_matrices = np.array(
        [get_geocentric_transformation_matrices(t)[2] for t in time]
    )
...
def GSM_to_GSE(bx, by, bz, time):
    ...
    """
    logger.info(f"Converting GSM to GSE for {len(bx)} data points")
...
def GSE_to_RTN_approx(bx, by, bz):
    ...
    logger.info(f"Converting GSE to RTN approx for {len(bx)} data points")
...
def GSM_to_RTN_approx(x, y, z, bx, by, bz, time):
    ...
    logger.info(f"Converting GSM to RTN approx for {len(bx)} data points")
...
def GSE_to_HEE(bx, by, bz):
    ...
    logger.info(f"Converting GSE to HEE for {len(bx)} data points")
...
def HEE_to_GSE(bx, by, bz):
    ...
    logger.info(f"Converting HEE to GSE for {len(bx)} data points")
...
def HEE_to_HAE(bx, by, bz, time):
    ...
    logger.info(f"Converting HEE to HAE for {len(bx)} data points")
    ...
    transformation_matrices = np.array(
        [np.linalg.inv(get_heliocentric_transformation_matrices(t)[0]) for t in time]
    )
...
def HAE_to_HEE(bx, by, bz, time):
    ...
    logger.info(f"Converting HAE to HEE for {len(bx)} data points")
    ...
    transformation_matrices = np.array(
        [get_heliocentric_transformation_matrices(t)[0] for t in time]
    )
...
def HAE_to_HEEQ(bx, by, bz, time):
    ...
    logger.info(f"Converting HAE to HEEQ for {len(bx)} data points")
    ...
    transformation_matrices = np.array(
        [get_heliocentric_transformation_matrices(t)[1] for t in time]
    )
...
def HEEQ_to_HAE(bx, by, bz, time):
    ...
    logger.info(f"Converting HEEQ to HAE for {len(bx)} data points")
    ...
    transformation_matrices = np.array(
        [np.linalg.inv(get_heliocentric_transformation_matrices(t)[1]) for t in time]
    )
...
def HEEQ_to_RTN(x, y, z, bx, by, bz):
    ...
    logger.info(f"Converting HEEQ to RTN for {len(bx)} data points")
...
def RTN_to_HEEQ(x, y, z, bx, by, bz):
    ...
    logger.info(f"Converting RTN to HEEQ for {len(x)} data points")
